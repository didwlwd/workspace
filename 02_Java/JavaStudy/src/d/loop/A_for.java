...
//		
		 ...
		 * - 선언된 블록({}) 범위내에서만 접근이 가능하고 해당 블록이 종료되면 함께 사라진다.
		 */
...
//		int count;
//		
//		System.out.print("아메리카 몇잔을 구매하시겠습니까? : ");
//		count = sc.nextInt();
//		
//		int sum = 0;
...
//			sum += i;
//		}
//		System.out.println("1 ~ 100 까지의 총 합 : " + sum);
		
		//정수 n을 입력 받아서 1부터 n까지 1씩 증가하며 모든 수를 더해서 출력해라
...
//			sum += i;			
//		}
//		System.out.println("1 ~ " + num + "까지의 총 합 : "+sum);
		 ...
		 * 
		 * int num = Math.random(); // double형의 random수 이기 때문에 int로 받을 수 없음
		 * 
		 * int num = (int)Math.random(); (0.0 ~ 0.99999999999) -> 0 ~ 0
		 * int num = (int)(Math.random() * 10) + 1; (0.0 ~ 0.99999999999) -> 1 ~ 10
