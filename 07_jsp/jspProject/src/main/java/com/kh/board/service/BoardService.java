...
public class BoardService {
	...
	public int selectAnnouncement() {
		Connection conn = getConnection();
		
		int listCount = new BoardDao().selectAnnouncement(conn);
		close(conn);
		return listCount;
	}
	
	public ArrayList<Notice> selectlistAnnouncemnet(){
		Connection conn = getConnection();
		
		ArrayList<Notice> nlist = new BoardDao().selectlistAnnouncemnet(conn);
