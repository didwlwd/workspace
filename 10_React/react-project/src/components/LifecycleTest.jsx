...
/*
    ...
    state값이 변경되는 리액트는 변화를 감지하고 그에 맞게 컴포넌트를 리렌더링 한다.
    그래서 state값을 변경할 때는 state에 어떤 숫자를 직접 넣어서 변경하는 것이 아닌
...
export class LifecycleTest extends Component {
    constructor(props){
        ...
        //저장하고싶은 데이터를 state라는 객체에 key-value형태로 저장된다.
        this.state = {
            count : 0,
        }

        console.log("constructor : 컴폰넌트 생성자 호출");
    }
