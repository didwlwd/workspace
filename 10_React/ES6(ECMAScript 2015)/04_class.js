...
//클래스를 만들어주면 Scope를 생성해준다. 체인형식으로 묶인다.

//class Person{ // 기본적인 클래스
const Person = class{ // 변수에 클래스를 부여할 수도 있다.
    constructor(name, age){ // js에서 생성자의 명칭은 주조건 constructor
        this.name = name;
        this.age = age;
        this.gender = "M";
    }
...
class Student extends Person{
    ...
    introduce(){
        console.log(`제 이름은 ${this.name}이며 나이는 ${this.grade}입니다.`);
    }
}
