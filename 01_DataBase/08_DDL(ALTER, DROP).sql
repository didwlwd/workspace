/*
    ...
    객체를 생생(CREATE), 변경(ALTER), 삭제(DELETE) 하는 구문
...
--3_2)제약조건명변경 : RENAME CONSTRAINT 기존제약조건명 TO 바꿀제약조건
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C008523 TO DTABLE_ID_NN;
