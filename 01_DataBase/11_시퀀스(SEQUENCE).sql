...
/*
    ...
    [START WITH 시작숫자 -> 처음 방생시킬 시작값 지정(기본값)
    [INCREMENT BY 숫자 -> 몇씩 증가시킬 건지 (기본값_
    [MAXLALUES 숫자] -> 최대값지정 (기본값 매우크다)
    [MINVALUES 숫자] -> 최소값지정(기본값 1)
    [CYCLE | NOCYCLE] -> 값 순환여부 [기본값 NOCYCLE]
    [CACHE | NPCACHE] -> 캐시메모리 할당 (기본값 SACKE 20)
...
/*
    ...
    시퀀스명.NEXTVAL : 시퀀스값에 일정한 값을 증가시켜 발생한 값
                        현재시퀀스 값에 INCREMENT BY 값 만큼 증가한 값
*/
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME,EMP_NO,JOB_CODE, HIREDATE)
VALUES (SEQ_EID.NEXTVAL, '김말숙', '111111-1111111', 'J6',SYSDATE);
