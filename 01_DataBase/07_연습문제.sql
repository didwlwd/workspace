...
WHERE SUBSTR(EMP_NO,1,2) IN (SELECT SUBSTR(EMP_NO,1,2)
                                FROM EMPLOYEE
                                WHERE EMP_NO BETWEEN '70' AND '79')
                                
AND SUBSTR(EMP_NO,8,1) IN (SELECT SUBSTR(EMP_NO,8,1)
                                    FROM EMPLOYEE
                                    WHERE SUBSTR(EMP_NO,8,1) IN ('2','4'))
                                    
AND SUBSTR(EMP_NAME,1,1) IN (SELECT SUBSTR(EMP_NAME,1,1)
                    FROM EMPLOYEE
