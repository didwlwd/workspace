package com.example.kinder.config;

import com.example.kinder.auth.JwtTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .anyRequest().authenticated() //위의 요청경로를 제외한 나머지 경로는 인증이 필요함
                )
